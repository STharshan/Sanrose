...
export default function ServiceSection() {
  const services = [
    {
      title: "Visiting Care",
      desc: "Visiting care provides regular support at home, helping with daily tasks, personal care, and companionship. It’s flexible and tailored to meet individual needs while allowing clients to remain independent.",
      icon: <UserCheck size={44} className="text-[#1F6D6D]" />,
    },
    {
      title: "Live-in Care",
      desc: "Live-in care offers round-the-clock support in the comfort of one’s own home. A dedicated caregiver assists with daily routines, personal care, and emotional support, ensuring safety and continuity of care.",
      icon: <Home size={44} className="text-[#1F6D6D]" />,
    },
    {
      title: "24 Hour Care",
      desc: "24-hour care provides continuous support for individuals with complex or high-dependency needs. Caregivers are available throughout the day and night to ensure safety, health, and comfort at all times.",
