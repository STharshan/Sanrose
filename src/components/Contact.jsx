  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-teal-50 via-blue-50 to-cyan-50">
          ...
          <div className="space-y-8">
            <div>
              <p className="text-teal-600 font-semibold text-sm tracking-wider uppercase mb-4">
                Contact Sanrose Health Care
              </p>
              <h1 className="text-4xl font-bold text-teal-900 leading-tight">
                We provide home care across Milton Keynes and all surrounding areas.
              </h1>
            </div>
            ...
            <div className="space-y-6 mt-12">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">admin@blessingscareltd.co.uk</p>
                </div>
              </div>
      ...
      <div className="w-full max-w-6xl mx-auto h-64 md:h-80 lg:h-96 mb-15">
        <iframe
         src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2456.175954811684!2d-0.7196539000000001!3d52.0036716!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487654d8cba1d5a3%3A0x3cad080f18323372!2s11%20Bilton%20Rd%2C%20Bletchley%2C%20Milton%20Keynes%20MK1%201HW%2C%20UK!5e0!3m2!1sen!2slk!4v1763132988707!5m2!1sen!2slk"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen=""
